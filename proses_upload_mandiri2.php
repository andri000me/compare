...
if(isset($_FILES['berkas_excel']) && in_array($_FILES['berkas_excel']['type'], $file_mimes))
{
    ...
    {      
        ...
        */
        ...
        mysqli_query($koneksi, "INSERT INTO mandiri(account_no,date_pd,trx_code,description1,description2,debit,credit,tanggal_hpt,kode_gerbang,create_date) VALUES('$account_no','$date_pd','$trx_code','$description1','$description2','$debit','$credit','$tanggal_hpt_dd','$kode_gerbang','$create_date' ) ON DUPLICATE KEY UPDATE description2='$description2' ");
    }
